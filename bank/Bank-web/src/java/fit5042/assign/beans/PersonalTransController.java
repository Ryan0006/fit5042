 ...
 * @author jerrychen
 */
@Named(value = "personalTransController")
@RequestScoped
public class PersonalTransController implements Serializable {
    ...
    public PersonalTransController() {
    }
    ...
    public void viewPersonalTransactions() throws Exception {
        transactions = transactionRepository.getTransactionByUser(currentUser.getUser());
